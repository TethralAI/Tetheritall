...
export declare class EgressGuard {
    ...
    constructor(cache: ConsentCache, classifier: PrivacyClassifier, minimizer: MinimizationService, bus: EventBus, localOnly: LocalOnlyModeService, repos: OptionalRepos);
